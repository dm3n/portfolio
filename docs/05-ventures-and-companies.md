...
| | Flagpost | Airbank | Finsider |
|---|---|---|---|
| **Role** | Co‑founder & CEO | Founder | CTO (full‑time) |
| **Backing** | Antler Canada (SAFE) | bridge venture | funded fintech |
...
### Private data room
A consolidated data room containing investor materials, signed customer/partner agreements, and relationship records is maintained privately and is **available to counsel on request**. It is intentionally not linked publicly from this repository to protect the privacy of investors, customers, and partners.
